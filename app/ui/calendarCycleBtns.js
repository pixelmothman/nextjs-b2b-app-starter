...
export default function CalendarCycleBtns({}){
    ...
    return (
        ...
        className="w-fit h-8 px-2 flex items-center justify-center border border-neutral-800 rounded-md shadow-sm text-neutral-800 font-bold hover:bg-neutral-800 hover:fill-neutral-100"
        >
