...
export default function CalendarCycleBtns({}){
    ...
    return (
        ...
        className="w-fit flex items-center justify-center px-2 py-2 border border-neutral-800 rounded-md shadow-sm text-neutral-800 font-bold hover:bg-neutral-800 hover:fill-neutral-100"
        >
